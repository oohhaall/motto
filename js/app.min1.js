...
function() {
	...
	/*window.matchMedia("(min-width: 1024px)").matches && ($("#masthead").hasClass("akademik") ? $("#masthead").parallax({
        imageSrc: "ar" == Resource.Language ? "images/academic_ar.jpg" : "images/akademik.jpg",
        naturalHeight: 1,
        speed: .1
    }) : $("#masthead").hasClass("detail") ? $("#masthead").parallax({
        imageSrc: "images/masthead-detail.jpg",
        naturalHeight: 1,
        speed: .1
    }) : $("#masthead").hasClass("law") ? $("#masthead").parallax({
        imageSrc: "ar" == Resource.Language ? "images/law_ar.jpg" : "images/masthead-law.jpg",
        naturalHeight: 1,
        speed: .1
    }) : $("#masthead").hasClass("references") ? $("#masthead").parallax({
        imageSrc: "images/masthead-references.jpg",
        naturalHeight: 1,
        speed: .1
    }) : $("#masthead").hasClass("translators") ? $("#masthead").parallax({
        imageSrc: "images/slide10.jpg",
        naturalHeight: 1,
        speed: .1
    }) : $("#masthead").hasClass("medical") ? $("#masthead").parallax({
        imageSrc: "images/medikal.jpg",
        naturalHeight: 1,
        speed: .1
    }) : $("#masthead").parallax({
        imageSrc: "ar" == Resource.Language ? "images/masthead_ar.jpg" : "images/masthead.jpg",
        speed: .1
    }), $("#slide2").parallax({
...
var Summary = function() {
        var e = {
            ...
            l = function() {
                ...
                var e = parseInt($("body").height())-parseInt($("footer").height())-770; // $("#mainFooter").offset().top - ($("#orderWr").height() + $("#mainHead").height() + 32);
                $("#orderWr").followTo(e)
            };
        return {
            init: t,
    ...
    Order = function() {
        var e = {
            ...
            l = function(e) {
                Summary.displayTotalsProgress(), $.post(Resource.Urls.removeFile, {
                    ...
                    if (t.success) {
                        ...
                        }), 0 == n && $("#fileInfo").removeClass("fileSelected"), v(), d(t), passVisitorNotesToChat(c())
                    }
            ...
            p = function(n) {
                ...
                i && (n.preventDefault(), y(Resource.Text.DOCUMENTS_BEING_ANALYZED_IN_CAT_TOOL, Resource.Text.DONT_WANT_TO_WAIT_FOR_QUOTE, function() {
            ...
            f = function() {
                e.displayThanksModal && $("#thanksModal").modal(), $("#newOrderForm").submit(function(e) {
                    ...
                    y(Resource.Text.FILE_BEING_PROCESSED), $(this).closest("form").submit()
                }), $("#fileUpload").click(function() {
                    $("li.wordCount:visible").hide(), $("#hiddenUpload").click()
                }), $("#textUpload").click(function(e) {
                    $("li.wordCount:visible").hide(), $("#metinGiris").val().length > 0 && (y(Resource.Text.TEXT_BEING_PROCESSED),
                    ...
                    !t && e.length > 0 && e.is(":checked") && (m(), $("#error-modal .modal-body .message").text(Resource.Text.NOTARISATION_REQUIRES_CERTIFIED_TRANSLATOR), $("#error-modal").modal()), u()
                }), v(), g()
            },
            m = function() {
            ...
            g = function() {
                m(), $('input[name^="extraService_"][data-name="NOTARISATION"]').click(function() {
                    var e = $('input[name^="extraService_"][data-name="CARGO_DELIVERY"]');
                    $(this).is(":checked") && e.length > 0 && !e.is(":checked") && e.prop("checked", !0), m()
                })
            },
            v = function() {
            ...
            k = function(t) {
                ...
                }), a($("#fileLanguageId").val()), w(), b(), x(), C(), f()
            };
        return {
            init: k,
            reloadProject: T
    ...
    Payment = function() {
        var e = {
                ...
                capturePaymentStatus: 0,
                bkmHtmlContent: ""
            },
            t = function() {
                1 == e.capturePaymentStatus && setInterval(function() {
                    $.post(Resource.Urls.capturePaymentStatus, {
                        reference: e.paymentTransactionId
                    }).done(function(e) {
                        var t = $.parseJSON(e);
                        (t.completed || t.cancel) && (window.location.href = t.returnUrl)
                    })
                }, 15e3), r(), i(), o(), s(), n(), Summary.adjustVisibility()
            },
            n = function() {
                $("#fileUpload").click(function() {
