	 ...
	 <div class="banAltMenu">
	  ...
	  <table id="ekleTablo" width="100%" border="0" cellpadding="5" cellspacing="0">
		  <tr>
		    ...
		    <td width="851"><input name="tarih" type="text" class="kutu" id="tarih"></td>
	      </tr>
          <tr>
		 ...
		 <tr>
          ...
          <tr>
		    <td width="127" class="k">İmza</td>
		    <td width="851"><input name="imza" type="text" class="kutu" id="imza"></td>
	      </tr>
