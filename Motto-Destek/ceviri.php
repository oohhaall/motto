...
$veriler = $DB->qry("SELECT * FROM ".$tablo." ORDER BY baslik ASC",1);
$sira = 0;
  ...
  <tr>
    <td height="0" align="left" valign="top">
	 <div class="banAltMenu">
	  	<a href="<?php echo $tablo; ?>.php"><li id="Clk">Çeviri Menüler</li></a>
        <a href="<?php echo $tablo; ?>Ekle.php"><li>Çeviri Menü Ekle</li></a> 
