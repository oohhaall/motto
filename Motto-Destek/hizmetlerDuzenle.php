  ...
  <tr>
    <td height="0" align="left" valign="top">
	 <div class="banAltMenu">
	  	<a href="<?php echo $tablo; ?>.php"><li id="Clk">Hizmetler Menüler</li></a>
        <a href="<?php echo $tablo; ?>Ekle.php"><li>Hizmetler Menü Ekle</li></a>         
        <li id="Clk">Hizmetler Menü Düzenle</li>
