...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" class="tablo">
 ...
 <td width="851"><input name="baslik" type="text" class="kutu" id="baslik" value="<?php echo $duzenle['baslik']; ?>"></td>
          ...
          <tr>
		    ...
		    <td><textarea class="ckeditor" name="paket" id="paket"><?php echo $duzenle['paket']; ?></textarea>
            </td>
	      </tr>
 ...
 <td width="851"><input name="fiyat" type="text" class="kutu" id="fiyat" value="<?php echo $duzenle['fiyat']; ?>"></td>
	      </tr>
