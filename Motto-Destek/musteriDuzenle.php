...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" class="tablo">
  ...
  <tr>
    <td height="0" align="left" valign="top">
	 <div class="banAltMenu">
	  <a href="<?php echo $tablo; ?>.php"><li id="Clk">Müşteri Yorumları</li></a>
        <a href="<?php echo $tablo; ?>Ekle.php"><li>Müşteri Yorum Ekle</li></a>      
        <li id="Clk">Müşteri Yorum Düzenle</li>
	  ...
	  <table id="ekleTablo" width="100%" border="0" cellpadding="5" cellspacing="0">
          ...
          <tr>
		    <td width="127" class="k">Tarih</td>
 <td width="851"><input name="tarih" type="text" class="kutu" id="tarih" value="<?php echo $duzenle['tarih']; ?>"></td>
	      </tr>
 ...
 <td width="851"><input name="baslik" type="text" class="kutu" id="baslik" value="<?php echo $duzenle['baslik']; ?>"></td>
		 ...
		 <tr>
          ...
          <tr>
		    <td valign="top" class="k">İmza</td>
		    <td><input name="tarih" type="text" class="kutu" id="tarih" value="<?php echo $duzenle['imza']; ?>">  
            </td>
	      </tr>	  
